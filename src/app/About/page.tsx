        ...
        <div className="flex items-center justify-center w-full pb-5">
          <div className="relative h-[30vw] w-[30vw] max-h-[300px] max-w-[300px] rounded-full bg-white">
            <Image
              ...
              key={about?.id}
              src={
                about?.profilepic.url.startsWith("http")
