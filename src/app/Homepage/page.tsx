    ...
    "
      ...
      <div className="relative pt-20 px-8 z-20 flex flex-col items-center justufy-center text-center w-full max-w-5xl -translate-y-10">
        <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4 font-light">
          <div className="md:p-2 p-1 bg-red-500/50 backdrop-blur-lg rounded-2xl transition duration-300 hover:scale-105">
            {" "}
          ...
          <div className="md:p-2 p-1 bg-red-500/50 backdrop-blur-xl rounded-2xl transition duration-300 hover:scale-105">
            {" "}
            <p className="md:text-md text-sm text-white">
              {homepage.skill2}
            </p>{" "}
          ...
          <div className="md:p-2 p-1 bg-red-500/50 backdrop-blur-xl rounded-2xl transition duration-300 hover:scale-105 transition">
            {" "}
            <p className="md:text-md text-sm text-white">
              {homepage.skill3}
            </p>{" "}
        ...
        <h3 className="text-xl font-light md:text-2xl py-5">{homepage.bio}</h3>
        ...
        >
          <h3> Scroll Down </h3>
          <ArrowDownCircle size={40} className="pt-2" />
        </Link>
      </div>
    </section>
  );
